...
* W[0, :] = 1 -- Each column counts as 1 instance. You don't necessarily need this row, but this avoids a corner case where somehow p% of the split gives some other q% of each criteria. This row encourages q=p.
* W[1-9, :] ~ U[1,10)
